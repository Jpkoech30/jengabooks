...
-- CreateIndex
CREATE INDEX "recurring_journal_templates_companyId_isActive_idx" ON "recurring_journal_templates"("companyId", "isActive");

-- CreateIndex
CREATE INDEX "recurring_journal_templates_companyId_nextRunDate_idx" ON "recurring_journal_templates"("companyId", "nextRunDate");

-- CreateIndex
CREATE INDEX "recurring_journal_templates_nextRunDate_idx" ON "recurring_journal_templates"("nextRunDate");
...
-- AddForeignKey
ALTER TABLE "recurring_journal_templates" ADD CONSTRAINT "recurring_journal_templates_companyId_fkey" FOREIGN KEY ("companyId") REFERENCES "companies"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "recurring_journal_templates" ADD CONSTRAINT "recurring_journal_templates_createdById_fkey" FOREIGN KEY ("createdById") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "sandboxes" ADD CONSTRAINT "sandboxes_companyId_fkey" FOREIGN KEY ("companyId") REFERENCES "companies"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
